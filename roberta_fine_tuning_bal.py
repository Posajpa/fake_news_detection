...
if __name__ == "__main__":
    ...
    coaid_path = "datasets/coaid_df2.csv"
    constraint_path = "datasets/constraint_df.csv"
    ...
    full_model_title = f"{model_log} fine-tuned on {coaid_percent}% of coaid - seed {seed}"
    ...
    # Load data
    coaid_texts, coaid_labels = load_data(coaid_path, "clean_text", "label")
    cons_texts, cons_labels = load_data(constraint_path, "clean_text", "new_label")
    ...
    scheduler = get_scheduler(
        "linear", optimizer=optimizer, num_warmup_steps=int(0.06 * num_training_steps),
