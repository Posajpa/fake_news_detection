...
def undersample_data(texts, labels):
    ...
    undersampler = RandomUnderSampler(sampling_strategy=0.5)  # Equalize both classes
...
if __name__ == "__main__":
    ...
    full_model_title = f"{model_log} with {layers_frozen} layers frozen fine-tuned on {coaid_percent}% of coaid"
